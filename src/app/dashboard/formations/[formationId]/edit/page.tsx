...
export default async function EditFormationPage({ params, searchParams }: PageProps) {
  ...
  console.log("🔍 NEW ROUTE - Debugging - User:", {
    id: session.user.id,
  ...
  console.log("🔍 NEW ROUTE - Debugging - Formation:", {
    found: !!formation,
    id: formation?.id,
  ...
  console.log("🔍 NEW ROUTE - Debugging - Permissions:", {
    canEdit,
    canView,
    isReadOnly,
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
          <div className="border-b border-gray-200 bg-gradient-to-r from-gray-50 to-blue-50">
            <nav className="flex space-x-0 px-6">
              <TabLink 
                href={`/dashboard/formations/${formation.id}/edit?tab=basics`}
              ...
              <TabLink 
                href={`/dashboard/formations/${formation.id}/edit?tab=sections`}
              ...
              <TabLink 
                href={`/dashboard/formations/${formation.id}/edit?tab=resources`}
              ...
              <TabLink 
                href={`/dashboard/formations/${formation.id}/edit?tab=apprenants`}
